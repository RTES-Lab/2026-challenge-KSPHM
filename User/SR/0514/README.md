...
## [2026-05-14] 앙상블 파이프라인 (옵션 B) ⚠️ 삭제예정-data leakage

> **주의**: 이 섹션의 LOOCV 점수(0.5937 등)는 사전계산 HI(v3)를 사용해 data leakage가 있음. 실제 성능이 아님. 자세한 내용은 `problem.md` 참조.
...
| **평균**     | **0.6068**             | 0.4867                 | 0.4800               | **0.5937** (삭제예정-data leakage) |
