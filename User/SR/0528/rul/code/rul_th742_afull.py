"""
User/SR/0528 — A-full Baseline & Align start_obs Bearing RUL Pipeline
===================================================================
작업자: SR/0520
핵심 접근법:
...
# SR/0520 출력 디렉토리
OUT_DIR   = BASE / "User/SR/0528/rul/output/afull"
...
def run_loocv(train_dfs, train_regs, params, sigma, feat_w, grp_w, aux_features, aux_w, aux_s):
    ...
    with open(OUT_DIR / "loocv_log.txt", "w", encoding="utf-8") as f:
        f.write("SR/0528 — A-full Baseline & Align start_obs Bearing RUL Pipeline\n")
    ...
    fig.suptitle("SR/0528 A-full LOOCV — Recalculated LOO-baseline HI", fontsize=12)
...
def run_test_inference(hi_train_all, results, best_config, best_cf,
    ...
    fig.suptitle(f"SR/0528 Test RUL — Train-baseline HI & Align start_obs  cf={best_cf:.2f}", fontsize=12)
...
if __name__ == "__main__":
    print("=" * 60)
    print("SR/0528 — A-full Baseline & Align start_obs RUL Pipeline")
    print("=" * 60)
